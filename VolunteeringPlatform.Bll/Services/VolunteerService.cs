...
namespace VolunteeringPlatform.Bll.Services
{
    public class VolunteerService : IVolunteerService
    {
        ...
        {
            var pagedVolunteersDto = await _repository.GetPagedData<Volunteer, VolunteerListDto>(pagedRequest);
            return pagedVolunteersDto;
        }

        public async Task ParticipateInProject(int projectId, int volunteerId)
        {
        ...
        public async Task ParticipateInGoodDeed(int goodDeedId, int volunteerId)
        {
